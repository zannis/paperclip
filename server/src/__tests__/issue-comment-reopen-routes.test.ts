...
describe.sequential("issue comment reopen routes", () => {
  ...
  it("does not wake the parent when a review-approval comment makes a grouped child done", async () => {
    const reviewerAgentId = "33333333-3333-4333-8333-333333333333";
    const policy = await normalizePolicy({
      stages: [
        {
    ...
    expect(
      mockIssueService.getWakeableParentAfterChildCompletion,
  ...
  it("wakes the parent when a review-approval comment makes an ordinary child done", async () => {
    const reviewerAgentId = "33333333-3333-4333-8333-333333333333";
    const policy = await normalizePolicy({
      stages: [
        {
